...
if __name__ == "__main__":
    ...
    goalconfig = [-7.3, 0.8, 1 ,1.0 ,0.0 ,0.0 ,0.0];
    startconfig = [ 7.0,-1.5 ,0.9 ,1.0, 0.0, 0.0, 0.0 ];
    ...
    with env:
        ...
        workspaceBound = [-18.5,18.5,-2.2,2.2,0.21,1.54]
        ...
        #########################################
        #########################################
        NarrPtNeg = [-5,0.8,1.1,-0.8,0,0.2,-0.5];
        NarrPtPos = [5,-0.8,1.2,-0.5,0.2,0,0.8];
    ...
    awayconfig = [1000,1000,1000,1,0,0,0]
    for num in range(0,20):
        robotAni[num].SetActiveDOFValues(awayconfig)
